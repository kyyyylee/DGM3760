...
function addNewTodo() {
  var newTodoName = document.getElementById("input").value;
  var newTodo = {
    todoID: todos.length,
...
function populateList(todos) {
  todos.forEach(function (todo) {
    var complete = todo.todoComplete ? "done" : "";
    var listItem = "<li class=\"".concat(complete, "\">\n    ").concat(todo.todoText, "\n    <span class=\"editBtn\"><i class=\"fa fa-edit\"></i></span>\n    <span> <i class=\"fa fa-trash\"></i></span>\n  </li>");
...
function numberLeft() {
  ...
  pendingTasks.innerHTML = "You have ".concat(count, " pending tasks.");
  return count;
}
